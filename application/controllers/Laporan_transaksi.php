...
class Laporan_transaksi extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('laporan_transaksi/index');
    ...
    public function lap_transaksi()
    {
        ...
        $data['lap_transaksi'] = $this->Lap_transaksi_model->Laporan_transaksi($tgl_mulai, $tgl_ambil);
        $data['total'] = $this->Lap_transaksi_model->total($tgl_mulai, $tgl_ambil);
        
        $this->load->view('templates/header',$data);
        $this->load->view('laporan_transaksi/lap_transaksi',$data);
        $this->load->view('templates/footer');
    }
    ...
    public function cetak_laporan_transaksi()
    {
        ...
        $data['lap_transaksi'] = $this->Lap_transaksi_model->Laporan_transaksi($tgl_mulai, $tgl_ambil);
        $data['total'] = $this->Lap_transaksi_model->total($tgl_awal, $tgl_akhir);
        
        $this->load->view('laporan_transaksi/cetak_laporan_transaksi',$data);
    }
